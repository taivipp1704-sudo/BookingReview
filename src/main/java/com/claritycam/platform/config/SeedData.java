...
import com.claritycam.platform.booking.BookingOperationsService;
import com.claritycam.platform.booking.BookingState;
import com.claritycam.platform.catalog.BundleLine;
import com.claritycam.platform.catalog.BundleRepository;
import com.claritycam.platform.catalog.BundleVersionService;
...
import com.claritycam.platform.inventory.InventoryLedgerEntry;
  ...
  CommandLineRunner seed(
    ...
    return args -> {
      ...
      bookings.saveAll(List.of(
          booking("ORD-202601", "Trần Gia Bảo", "0933111222", BookingState.PENDING_REVIEW, 4_200_000, tomorrow, tomorrow.plusDays(2), "BND-001", "Khách muốn nhận máy sớm nếu kho sẵn sàng.", List.of(new BookingLine("GEAR-001", null, 1), new BookingLine("ACC-003", null, 2))),
